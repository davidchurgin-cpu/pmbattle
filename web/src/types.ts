...
export interface Order { id: string; exchange: string; ticker: string; rotation?: string; game?: string; outcome?: string; market: string; side: 'yes' | 'no'; status: string; quantity: Money; filledQuantity: Money; limitPrice: Money; cashRisk: Money; createdAt: string }
...
export interface Fill { id: string; orderId?: string; exchange: string; ticker: string; eventId?: string; rotation?: string; game?: string; team?: string; market: string; side?: string; quantity: Money; rawPrice: Money; allInMoneyline: number; fee: Money; cashRisk: Money; createdAt: string }
export interface Position { exchange: string; ticker: string; eventId?: string; rotation?: string; game?: string; outcome?: string; market: string; side?: string; quantity: Money; cashRisk: Money; totalTraded?: Money; averagePrice: Money; currentPrice: Money; realizedPnl?: Money; unrealizedPnl: Money; feesPaid?: Money; updatedAt?: string }
export interface Settlement { exchange: string; ticker: string; eventTicker?: string; eventId?: string; rotation?: string; game?: string; outcome?: string; market?: string; result: string; yesQuantity: Money; noQuantity: Money; yesTotalCost: Money; noTotalCost: Money; revenue: Money; fee: Money; netPnl: Money; settlementValue: Money; settledAt: string }
