...
export interface Health { status: string; mode: string; scheduleUpdated: string; exchangeState: string; accountState: string; accountUpdated?: string; mappedMarkets: number; latencyMs: number; tradingEnabled: boolean; tradingLock?: string }
