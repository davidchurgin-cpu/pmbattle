...
export interface Order { id: string; exchange: string; ticker: string; rotation?: string; game?: string; outcome?: string; market: string; status: string; quantity: Money; filledQuantity: Money; limitPrice: Money; cashRisk: Money; createdAt: string }
